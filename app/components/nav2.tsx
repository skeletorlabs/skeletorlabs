...
export default function Nav2() {
  ...
  return (
    <div className="flex fixed w-full xl:w-[1280px] h-[100px] items-center justify-center lg:justify-between mt-10 px-8 xl:px-14 bg-violet-500/10 backdrop-blur-md z-50">
      <Image
        src="/logo-text.svg"
        width={277}
        height={77}
